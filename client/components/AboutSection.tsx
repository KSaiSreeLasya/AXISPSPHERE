...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="pt-20 pb-24 bg-gradient-to-b from-background to-luxury-50/30 relative overflow-hidden"
    >
      {/* Background Elements */}
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Founded in 2018, Axisphere MediaWorx LLP emerged from a simple belief:
